...
const features = [
  ...
  {
    title: "Copy Trading",
    description: "Seamlessly copy trades across multiple accounts and diversify your investments with ease.",
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" className="w-10 h-10">
  ...
  },
  {
    ...
    description: "Effortlessly copy expert traders and maximize your profits with our seamless copy trading feature.",
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" className="w-10 h-10">
  ...
  {
    title: "Bots",
    description: "Discover high-performance trading bots designed to maximize profits and minimize risk.",
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" className="w-10 h-10">
