              ...
              {testimonials.map((testimonial, index) => (
                <motion.div
                  ...
                  className={`absolute inset-0 rounded-xl backdrop-blur-sm transition-all duration-500 ${
                    index === currentIndex ? 'opacity-100 z-10 translate-x-0' : 'opacity-0 z-0 translate-x-8'
                  ...
                  <div className="flex flex-col h-full justify-between">
                    <div>
                      <div className="flex items-center justify-between mb-4">
                        <svg className="w-8 h-8 sm:w-10 sm:h-10 text-indigo-500/70" fill="currentColor" viewBox="0 0 24 24">
                      ...
                      <p className="text-base sm:text-lg italic mb-6 leading-relaxed text-zinc-300">{testimonial.quote}</p>
                    </div>
