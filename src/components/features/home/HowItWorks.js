...
const steps = [
  {
    ...
    description:
      'Sign up in minutes with our streamlined onboarding process. No complicated paperwork required.',
    icon: (
  ...
  },
  {
    ...
    description:
      'Securely link your existing brokerage account or create a new one through our trusted partners.',
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path
          strokeLinecap="round"
  ...
  },
  {
    ...
    description:
      'Choose from our library of pre-built algorithms or customize your own trading strategy.',
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path
          strokeLinecap="round"
  ...
  },
  {
    ...
    description:
      'Launch your algorithm and monitor performance in real-time through our intuitive dashboard.',
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path
          strokeLinecap="round"
              ...
              return (
                ...
                >
                  ...
                  <div className="absolute left-8 sm:left-12 md:left-1/2 transform -translate-x-1/2 w-16 h-16 rounded-full bg-gradient-to-br from-indigo-800/80 to-indigo-900/80 flex items-center justify-center z-10 border-2 border-indigo-600/30 shadow-lg shadow-indigo-900/30">
                    <span className="text-lg font-bold bg-clip-text text-transparent bg-gradient-to-r from-indigo-200 to-white">
                      {step.number}
                    </span>
                  </div>
                  ...
                  >
                    ...
                    >
                      ...
                      <h3 className="text-xl sm:text-2xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-white to-zinc-300">
                        {step.title}
                      </h3>
                    </div>
