        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          >
            ...
            <div className="relative h-64">
              ...
              <div className="absolute w-full h-px bg-zinc-700" style={{ bottom: '50%' }}>
                <span className="absolute -left-8 -translate-y-1/2 text-xs text-zinc-500">0.0%</span>
              </div>
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2 opacity-0 group-hover:opacity-100 transition-opacity bg-zinc-800 text-white text-xs rounded py-1 px-2 pointer-events-none whitespace-nowrap">
                        {months[index]}: {value > 0 ? '+' : ''}{value.toFixed(1)}%
                      </div>
              ...
              <div className="absolute top-[50%] left-0 right-0 flex justify-between items-start h-[50%]">
                {monthlyReturns.map((value, index) => {
                  ...
                  return (
                    ...
                    >
                      <div 
                        className="w-5 bg-zinc-800 hover:bg-zinc-600 transition-colors"
                      ></div>
                    </motion.div>
                  );
                })}
          ...
          >
            ...
            <div className="space-y-6">
              {[
                { label: "Annual Return", value: "24.7%", description: "Average annual return since inception" },
                { label: "Sharpe Ratio", value: "2.31", description: "Higher risk-adjusted returns than market" },
                { label: "Max Drawdown", value: "-12.4%", description: "Maximum observed loss from peak to trough" },
                { label: "Win Rate", value: "68.3%", description: "Percentage of profitable trades" },
                { label: "Beta", value: "0.42", description: "Lower volatility compared to market" }
              ].map((stat, index) => (
                <motion.div 
                  key={index}
