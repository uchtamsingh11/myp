...
import { subtractCoins, getUserCoinBalance } from '../../../lib/services/coin-management';
...
export default function ServicePurchase() {
  ...
  if (!user) {
    return <div className="text-center my-8 text-red-400">Please log in to purchase services.</div>;
  }
