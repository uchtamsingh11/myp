    ...
    <div className="pt-2 pb-8">
      <div className="flex justify-between items-center mb-6">
        ...
        <div className="flex items-center">
          {refreshSuccess && (
            <span className="text-green-500 mr-4 text-sm">
      ...
      {(updateSuccess || updateError) && (
        <div className={`mb-4 p-4 rounded ${updateSuccess ? 'bg-green-800/50 text-green-400' : 'bg-red-800/50 text-red-400'}`}>
          {updateSuccess || updateError}
        </div>
      )}
      ...
      {selectedUser && (
        <div className="fixed inset-0 bg-black/70 flex items-center justify-center z-50">
          <div className="bg-zinc-900 p-6 rounded-lg shadow-lg max-w-md w-full border border-zinc-700">
            <h3 className="text-xl font-bold mb-4">Manage Coins: {selectedUser.full_name || selectedUser.email}</h3>
            
            <div className="mb-4">
              <p className="text-sm text-gray-400 mb-2">Current coin balance: <span className="text-white font-bold">{selectedUser.coin_balance || 0}</span></p>
              ...
              >
                {updateLoading ? (
                  ...
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 mr-1" viewBox="0 0 20 20" fill="currentColor">
                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm-1-8a1 1 0 011-1h2a1 1 0 010 2h-2v2a1 1 0 11-2 0v-2H6a1 1 0 010-2h2V7a1 1 0 011-1z" clipRule="evenodd" />
                  </svg>
                )}
