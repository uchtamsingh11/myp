      ...
      <div className="max-w-3xl bg-zinc-800 rounded-lg p-6 shadow-lg">
        {submitSuccess ? (
          <div className="bg-green-500/20 text-green-400 p-4 rounded-md mb-6">
            Your ticket has been submitted successfully. Our support team will get back to you as
            soon as possible.
          </div>
        ) : null}

        {error ? (
          <div className="bg-red-500/20 text-red-400 p-4 rounded-md mb-6">{error}</div>
        ) : null}
          ...
          <div className="mb-6">
            ...
            <div className="border border-dashed border-zinc-700 rounded-md p-4 text-center">
              <svg
                ...
                className="h-8 w-8 mx-auto text-zinc-500 mb-2"
                fill="none"
                viewBox="0 0 24 24"
                stroke="currentColor"
              >
