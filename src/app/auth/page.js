...
const AuthContent = () => {
  ...
  const handleLoginSubmit = async e => {
    ...
    try {
      ...
      // Guarantee redirection after a short delay to ensure auth state is properly updated
      setTimeout(() => {
  ...
  return (
    <div className="min-h-screen bg-black flex flex-col">
      ...
      <div className="flex-1 flex items-center justify-center p-4 relative z-10">
        <motion.div
          className="relative bg-zinc-900/80 backdrop-blur-md border border-zinc-800 rounded-xl w-full max-w-md overflow-hidden shadow-2xl"
        ...
        >
          ...
          <div className="p-6 border-b border-zinc-800">
            <motion.h2
              className="text-3xl font-bold text-center text-white drop-shadow-[0_2px_3px_rgba(0,0,0,0.7)]"
          ...
          <div className="p-6">
            ...
            <form onSubmit={isLogin ? handleLoginSubmit : handleSignupSubmit}>
              ...
              >
                ...
                <motion.button
                  type="submit"
                  className="relative w-full bg-black text-white border border-zinc-800 hover:border-zinc-700 font-medium py-3 px-4 rounded-lg transition-colors overflow-hidden"
            ...
            <div className="grid grid-cols-2 gap-4">
              <motion.button
                className="relative flex items-center justify-center gap-2 bg-black text-white border border-zinc-800 hover:border-zinc-700 py-3 px-4 rounded-lg transition-colors overflow-hidden"
                whileHover={{ scale: 1.02 }}
                whileTap={{ scale: 0.98 }}
