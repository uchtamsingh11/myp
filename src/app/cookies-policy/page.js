        ...
        >
          ...
          <div className="bg-zinc-900 p-8 rounded-xl">
            ...
            <p className="text-zinc-300 mb-8">
              As is common practice with almost all professional websites, AlgoZ uses cookies, which
              are tiny files that are downloaded to your computer, to improve your experience. This
              page describes what information they gather, how we use it, and why we sometimes need
              to store these cookies. We will also share how you can prevent these cookies from
            ...
            <p className="text-zinc-300 mb-4">
              ...
              out, however in some cases they may remain afterward to remember your site preferences
              when logged out.
            </p>
            ...
            <p className="text-zinc-300 mb-4">
              ...
              analytics solutions on the web for helping us to understand how you use the site and
            ...
            <p className="text-zinc-300 mb-4">
              ...
              to ensure that you receive a consistent experience whilst on the site whilst ensuring
            ...
            <p className="text-zinc-300 mb-8">
              ...
              with your social network in various ways. For these to work, social media sites
              including Facebook, Twitter, and LinkedIn, will set cookies through our site which may
              be used to enhance your profile on their site or contribute to the data they hold for
